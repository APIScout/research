...
# Repository: https://github.com/Pezmc/BibLatex-Check
...
__author__ = "Pez Cuckow, Vincenzo Ferme"
__version__ = "0.1.4"
...
# Reference: http://microformats.org/wiki/citation-formats#BibTeX_citation_Types, and additional customization
requiredFields = {"article": ["author", "title", "journal", "year/date", "number", "volume"],
                  "book": ["author", "title", "publisher", "year/date"],
                  "mvbook": "book",
                  ...
                  "thesis": ["author", "title", "type", "school", "year/date"],
